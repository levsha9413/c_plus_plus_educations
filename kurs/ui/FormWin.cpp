...
FormWin::FormWin(wxWindow *parent, wxWindowID id, const wxString &title, const wxPoint &pos, const wxSize &size,
   ...
   closeButton = new wxButton(this, wxID_CLOSE,
                              ...
                              wxSize(100, 10),
                              wxBU_BOTTOM);
    nameLabel = new wxStaticText(this, -1, " Name:  " + employee->getName(), wxPoint(10,10),
                                 wxDefaultSize, 0, "nameLabel");
    sernameLabel = new wxStaticText(this, -1, " Sername:  " + employee->getSurname(), wxPoint(10,60),
                                    wxDefaultSize, 0, "sernameLabel");
    patronymicLabel = new wxStaticText(this, -1, " Patronymic:  " + employee->getPatronymic(), wxPoint(10,110),
                                       wxDefaultSize, 0, "patronymic");
    workExperience = new wxStaticText(this, -1, " Work exp: " + std::to_string(employee->getWorkExperience()) + " months", wxPoint(10,110),
                                       wxDefaultSize, 0, "work exp");
    employer = new wxStaticText(this, -1, " Employer:  " + employee->getEmployer(), wxPoint(10,110),
                                       wxDefaultSize, 0, "employer");
    averageGrade = new wxStaticText(this, -1,
                                    " Average Grade:  " + employee->getAverageGrade(),
                                    wxPoint(10,110),
                                wxSize(150, 200), 0, "averageGrade");
